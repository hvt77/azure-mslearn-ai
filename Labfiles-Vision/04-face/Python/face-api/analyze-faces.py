    ...
    with open(image_file, mode="rb") as image_data:
        ...
        if len(detected_faces) > 0:
            ...
            for face in detected_faces:
                ...
                print(' - Accessories: {}'.format(face.face_attributes.accessories))
                print(' - Noise: {}'.format(face.face_attributes.noise))
                print(' - Occlusion: {}'.format(face.face_attributes.occlusion))
